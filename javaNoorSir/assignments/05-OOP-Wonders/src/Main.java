public class Main {
    public static void main(String[] args) {
         ...
         * e1Employee.name,e1Employee.id, e1Employee.salary);
         * 
         ...
         * s1Student.name, s1Student.rollNumber,s1Student.program, s1Student.batch);
         */

        Car c1 = new Car("Tesla", "M1", 2022);
        System.out.println("Brand: " + c1.getBrand() + ", Model: " + c1.getModel() + ", Year: " + c1.getYear() + "\n");

        Circle cir1 = new Circle(4.20);
        System.out.println("Radious: " + cir1.getRadious() + "\n");

        Employee e1 = new Employee("Fahim", 103, 100000);
        System.out.println("Name: " + e1.getName() + ", ID: " + e1.getId() + ", Salary: " + e1.getSalary() + "\n");

        Rectangle r1 = new Rectangle(2.2, 4.4);
        System.out.println("Area: " + (r1.getLength() * r1.getWidth()) + "\n");

        Student s1 = new Student("Fahim", 103, "CSE", 63);
        System.out.println("Name: " + s1.getName() + ", Roll: " + s1.getRollNumber() + ", Program: " + s1.getProgram()
                + ", Batch: " + s1.getBatch());
    }
}